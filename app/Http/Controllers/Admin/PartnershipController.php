...
class PartnershipController extends Controller
{
    ...
    public function store(Request $request)
    {
        try 
        {
            ...
            { 
                ...
                $file->move('image/partnership/', $filenameIcon);
            }


                $save = Partnership::create([

                    'image'             => 'image/partnership/'. $filenameIcon,
                    'title'              => $request->title,
                    'link'              => $request->link,
    ...
    public function update(Request $request)
    {
        ...
        try 
        {
                ...
                { 
                    ...
                    $save = Partnership::where('idPartership',$id)->update([
    ...
    {
        $data = Partnership::orderBy('created_at', 'DESC')
                        ->orderBy('status', 'DESC');
