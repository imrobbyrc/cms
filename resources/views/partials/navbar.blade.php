                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNavDropdown">
                        <ul class="navbar-nav fs-0 fw-700">
                            ...
                            <li><a href="/">Menu Layout 1</a>
                                <ul class="dropdown fs--1">
                                    <li><a href="sub-menu">Submenu Layout 1</a></li>
                                    <li><a href="sub-menu-2">Submenu Layout 2</a></li>
                                </ul>
                            </li>
                            <li><a href="menu-2">Menu Layout 2</a>
                                <ul class="dropdown fs--1">
                                    <li><a href="sub-menu">Submenu Layout 1</a></li>
                                    <li><a href="sub-menu-2">Submenu Layout 2</a></li>
                                </ul>
                            ...
                            <li><a class="d-block mr-md-9" href="contact-us">Contact Us</a></li>
                        </ul>
