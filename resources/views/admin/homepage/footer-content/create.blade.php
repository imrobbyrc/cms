  ...
  <div class="card">
      ...
      <div class="card-body">
        ...
        <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
                <input type="number" class="form-control" required="" name="priority" value="{{ old('priority') }}" required>
                <div class="invalid-feedback">
                Priority Required
                </div>
            </div>
        ...
        <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
                <textarea class="summernote" name="descriptions" required>{{ old('descriptions') }}</textarea>
                <div class="invalid-feedback">
