  ...
  <aside id="sidebar-wrapper">
    ...
    <ul class="sidebar-menu">   
      ...
      <li class="dropdown">
        ...
        <ul class="dropdown-menu">
          <li class=""><a href="/admin/contact-us/contact-us"><i class="fas fa-images"></i>Contact</a></li>
          <li class=""><a href="/admin/contact-us/location"><i class="fas fa-map-marker-alt"></i>Location</a></li> 
        </ul>
      </li>
       ...
       <li class="dropdown">
         ...
         <ul class="dropdown-menu">
           <li class=""><a href="/admin/content/menu"><i class="fas fa-bars"></i>Menu</a></li>
           <li class=""><a href="/admin/content/submenu"><i class="far fa-minus-square"></i>Submenu</a></li>
           <li class=""><a href="/admin/content/content"><i class="far fa-newspaper"></i></i>Content</a></li>
         </ul>
       </li>
