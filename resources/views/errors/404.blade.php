...
<head>
    ...
    <link href="{{asset('assets/ionicons/2.0.1/css/ionicons.min.css')}}" rel="stylesheet">
...
<body data-spy="scroll" data-target=".inner-link" data-offset="60">
    <main>
        ...
        <section class="text-center py-0">
            <div class="background-holder overlay overlay-elixir" style="background-image:url(assets/images/background-14.jpg);"></div>
            <!--/.background-holder-->
            <div class="container">
                <div class="row h-full align-items-center color-white">
                    <div class="col" data-zanim-timeline="{}" data-zanim-trigger="scroll">
                        <a href="index-2.html" data-zanim='{"delay":0}'><img src="assets/images/logo-light.png" alt="" data-zanim='{"delay":0.1}' /></a>
                        ...
                        <div data-zanim='{"delay":0.4}'><a class="btn btn-lg btn-warning btn-capsule mt-4" href="index-2.html">Take Me Home</a></div>
                    </div>
                </div>
                <!--/.row-->
            </div>
    ...
    <script src="{{asset('assets/ajax/libs/popper.js/1.11.0/umd/popper.min.js')}}" integrity="sha384-b/U6ypiBEHpOf/4+1nzFpr53nxSS+GLCkfwBdFNTxtclqqenISfwAzpKaMNFNmj4" crossorigin="anonymous"></script>
